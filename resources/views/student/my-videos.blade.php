            ...
            <div class="my-video-card">
                <div class="my-video-card-body">
                    ...
                    <div class="my-video-tags">
                        ...
                        @endif
                        @if($resource->subject)
                            <span class="my-video-tag my-video-tag-green">{{ $resource->subject->name }}</span>
                        @endif
                        @if($resource->term)
                            <span class="my-video-tag my-video-tag-purple">{{ $resource->term->name }}</span>
                        @endif
                        @if($resource->classRoom)
                            <span class="my-video-tag my-video-tag-yellow">{{ $resource->classRoom->name }}</span>
                        @endif
                    </div>
