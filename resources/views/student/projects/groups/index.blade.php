...
<div class="groups-page">
    ...
    <div class="quick-actions">
        <a href="{{ route('student.projects.index') }}" class="action-btn action-btn-secondary">
            <i class="fas fa-arrow-left"></i>
            Back to Projects
        </a>
        <a href="{{ route('student.projects.groups.create') }}" class="action-btn action-btn-primary">
    ...
    <div class="section">
        <div class="section-header">
            <h2>My Groups</h2>
            <span class="section-count">{{ $myGroups->count() }} group{{ $myGroups->count() > 1 ? 's' : '' }}</span>
        </div>
        ...
        <div class="groups-grid">
            ...
            <div class="group-card">
                ...
                <div class="group-stats">
                    ...
                    <div class="stat">
                        <span class="stat-number">{{ $group->max_members }}</span>
                ...
                <div class="group-actions">
                    <a href="{{ route('student.projects.groups.show', $group) }}" class="btn btn-primary">
                        <i class="fas fa-eye"></i> View Details
                    </a>

                    @if($group->isLeader(Auth::user()) && !$group->isFull() && $group->status === 'open')
                    <button class="btn btn-secondary" onclick="toggleGroupStatus({{ $group->id }}, '{{ $group->status }}')">
                        <i class="fas fa-lock"></i> Close Group
                    </button>
                    @elseif($group->isLeader(Auth::user()) && $group->status === 'closed')
                    <button class="btn btn-secondary" onclick="toggleGroupStatus({{ $group->id }}, '{{ $group->status }}')">
    ...
    <div class="section">
        <div class="section-header">
            ...
            <span class="section-count">{{ $availableGroups->count() }} group{{ $availableGroups->count() > 1 ? 's' : '' }}</span>
        </div>
            ...
            <div class="group-card available-group">
                ...
                <div class="group-stats">
                    ...
                    <div class="stat">
                        ...
                        <span class="stat-value">{{ $group->creator->name }}</span>
                    </div>
                </div>
                ...
                <div class="group-actions">
                    <a href="{{ route('student.projects.groups.show', $group) }}" class="btn btn-outline">
                        <i class="fas fa-eye"></i> View Details
                    </a>
                    <form action="{{ route('student.projects.groups.join', $group) }}" method="POST" class="inline-form">
                        @csrf
