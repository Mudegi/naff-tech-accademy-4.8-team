                ...
                <div class="profile-avatar-section">
                    ...
                    <div class="profile-info">
                        ...
                        @if($user->school_id && $user->school)
                            <div class="profile-school" style="margin-top: 8px; padding-top: 8px; border-top: 1px solid #e5e7eb;">
                                <i class="fas fa-school" style="margin-right: 5px; color: #6b7280;"></i>
                                <span style="color: #6b7280; font-size: 0.875rem;">{{ $user->school->name }}</span>
                            </div>
                        @endif
                        @if($user->student && $user->student->registration_number)
                            <div class="profile-registration" style="margin-top: 4px;">
                                <i class="fas fa-id-card" style="margin-right: 5px; color: #6b7280;"></i>
                                <span style="color: #6b7280; font-size: 0.875rem;">Reg. No: {{ $user->student->registration_number }}</span>
                            </div>
                        @endif
                        @if($user->student && $user->student->class)
                            <div class="profile-class" style="margin-top: 4px;">
                                <i class="fas fa-graduation-cap" style="margin-right: 5px; color: #6b7280;"></i>
                                <span style="color: #6b7280; font-size: 0.875rem;">Class: {{ $user->student->class }}</span>
                            </div>
                        @endif
                    </div>
                </div>
