...
<head>
    ...
    <title>{{ config('app.name', 'Naf Academy') }} - Admin Dashboard</title>
    ...
    <div class="dashboard-container">
        ...
        <header class="mobile-header">
            ...
            <span class="mobile-title">
                @if(Auth::check() && (Auth::user()->account_type === 'teacher' || Auth::user()->account_type === 'subject_teacher'))
                    Teacher Dashboard
                @elseif(Auth::check() && Auth::user()->account_type === 'student')
                    Student Dashboard
                @elseif(Auth::check() && Auth::user()->account_type === 'parent')
                    Parent Portal
                @else
                    Admin Dashboard
                @endif
            ...
            <div class="mobile-profile" id="mobileProfileBtn">
                <div class="user-avatar">
                    @if(Auth::user()->profile_photo_path && file_exists(public_path('storage/' . Auth::user()->profile_photo_path)))
                        <img src="{{ asset('storage/' . Auth::user()->profile_photo_path) }}" alt="Profile Photo" class="header-avatar">
                    @else
        ...
        <aside id="sidebar" class="dashboard-sidebar">
            ...
            <nav class="sidebar-nav">
                @if($user->account_type === 'teacher' || $user->account_type === 'subject_teacher')
                    ...
                    <a href="{{ route('teacher.resources.index') }}" class="sidebar-link {{ request()->routeIs('teacher.resources.index') ? 'active' : '' }}">
                        <i class="fas fa-folder-open"></i> My Resources
                    </a>
                    <a href="{{ route('teacher.resources.upload.form') }}" class="sidebar-link {{ request()->routeIs('teacher.resources.upload.form') ? 'active' : '' }}">
                ...
                @elseif($user->account_type === 'student')
                    ...
                    <a href="{{ route('student.resources.index') }}" class="sidebar-link {{ request()->routeIs('student.resources.index') ? 'active' : '' }}">
                ...
                @endif
                @if((in_array('view_subject', $userPermissions) || in_array('view_topic', $userPermissions) || in_array('view_class', $userPermissions)))
                    <div class="sidebar-dropdown">
                        <button class="sidebar-dropdown-btn {{ request()->routeIs('admin.subjects.*') || request()->routeIs('admin.topics.*') || request()->routeIs('admin.classes.*') ? 'active' : '' }}" type="button">
                            📚 Academic Settings
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="sidebar-dropdown-content">
                @if(in_array('view_subject', $userPermissions))
                                <a href="{{ route('admin.subjects.index') }}" class="sidebar-link {{ request()->routeIs('admin.subjects.*') ? 'active' : '' }}">Subjects</a>
                @endif
                @if(in_array('view_topic', $userPermissions))
                                <a href="{{ route('admin.topics.index') }}" class="sidebar-link {{ request()->routeIs('admin.topics.*') ? 'active' : '' }}">Topics</a>
                @endif
                @if(in_array('view_class', $userPermissions))
                                <a href="{{ route('admin.classes.index') }}" class="sidebar-link {{ request()->routeIs('admin.classes.*') ? 'active' : '' }}">Classes</a>
                @endif
                @if(in_array('view_term', $userPermissions))
                                <a href="{{ route('admin.terms.index') }}" class="sidebar-link {{ request()->routeIs('admin.terms.*') ? 'active' : '' }}">
                                    <i class="fas fa-calendar-alt"></i> Terms
                                </a>
                @endif
                @if(in_array('view_resource', $userPermissions))
                ...
                @endif
                @if(in_array('view_messages', $userPermissions))
                ...
                @if(in_array($user->account_type, ['school_admin', 'director_of_studies', 'head_of_department']))
                    <div class="sidebar-dropdown">
                        <button class="sidebar-dropdown-btn {{ request()->routeIs('admin.assignments.*') || request()->routeIs('admin.teacher-assignments.*') || request()->routeIs('student.assignments.*') ? 'active' : '' }}" type="button">
                ...
                @if($user->account_type === 'teacher' || $user->account_type === 'subject_teacher')
                    ...
                    <a href="{{ route('teacher.standalone-assignments.index') }}" class="sidebar-link {{ request()->routeIs('teacher.standalone-assignments.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('teacher.messages.index') }}" class="sidebar-link {{ request()->routeIs('teacher.messages.*') ? 'active' : '' }}">
                    ...
                    <!-- Teacher Assessments -->
                    <a href="{{ route('teacher.assessments.index') }}" class="sidebar-link {{ request()->routeIs('teacher.assessments.*') ? 'active' : '' }}">
                    ...
                    <!-- Groups -->
                    <a href="{{ route('teacher.projects.groups.index') }}" class="sidebar-link {{ request()->routeIs('teacher.projects.groups.*') ? 'active' : '' }}">
                        <i class="fas fa-users"></i> Groups
                    </a>
                    <!-- Projects -->
                    <a href="{{ route('teacher.projects.index') }}" class="sidebar-link {{ request()->routeIs('teacher.projects.*') && !request()->routeIs('teacher.groups.*') ? 'active' : '' }}">
                ...
                @if((in_array('view_roles', $userPermissions) || in_array('view_permissions', $userPermissions) || $isSuperAdmin))
                    <div class="sidebar-dropdown">
                        <button class="sidebar-dropdown-btn {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') || request()->routeIs('admin.users.*') ? 'active' : '' }}" type="button">
                            🛡️ Roles & Permissions
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="sidebar-dropdown-content">
                @if(in_array('view_roles', $userPermissions) || $isSuperAdmin)
                                <a href="{{ route('admin.roles.index') }}" class="sidebar-link {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}">Roles</a>
                @endif
                @if(in_array('view_permissions', $userPermissions) || $isSuperAdmin)
                                <a href="{{ route('admin.permissions.index') }}" class="sidebar-link {{ request()->routeIs('admin.permissions.*') ? 'active' : '' }}">Permissions</a>
                            @endif
                            @if(in_array('view_users', $userPermissions) || $isAdmin)
                ...
                @if($isSuperAdmin)
                    ...
                    <a href="{{ route('admin.school-subscriptions.pending') }}" class="sidebar-link {{ request()->routeIs('admin.school-subscriptions.pending') ? 'active' : '' }}">
                        <i class="fas fa-check-circle"></i> Pending Approvals
                    </a>
                    <a href="{{ route('admin.university-cut-offs.index') }}" class="sidebar-link {{ request()->routeIs('admin.university-cut-offs.*') ? 'active' : '' }}">
                        <i class="fas fa-graduation-cap"></i> University Programs
                    </a>
                @endif
                @if(in_array('view_subscription_package', $userPermissions) || $isSuperAdmin)
                    <a href="{{ route('admin.subscription-packages.index') }}" class="sidebar-link {{ request()->routeIs('admin.subscription-packages.*') ? 'active' : '' }}">
                ...
                @endif
                @if(in_array('view_settings', $userPermissions) || $isSuperAdmin)
                    <div class="sidebar-dropdown">
                        <button class="sidebar-dropdown-btn {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}" type="button">
                            ⚙️ Settings
                            <i class="fas fa-chevron-down"></i>
                        </button>
                        <div class="sidebar-dropdown-content">
                            <a href="{{ route('admin.settings.company') }}" class="sidebar-link {{ request()->routeIs('admin.settings.company') ? 'active' : '' }}">
                                <i class="fas fa-building"></i> Company Settings
                            </a>
                            <a href="{{ route('admin.settings.flutterwave') }}" class="sidebar-link {{ request()->routeIs('admin.settings.flutterwave') ? 'active' : '' }}">
                                <i class="fas fa-credit-card"></i> Flutterwave Settings
                            </a>
                            <a href="{{ route('admin.settings.easypay') }}" class="sidebar-link {{ request()->routeIs('admin.settings.easypay') ? 'active' : '' }}">
                                <i class="fas fa-credit-card"></i> Easypay Settings
                            </a>
                            <a href="{{ route('admin.settings.sms') }}" class="sidebar-link {{ request()->routeIs('admin.settings.sms') ? 'active' : '' }}">
                                <i class="fas fa-sms"></i> SMS Settings
                            </a>
                            <a href="{{ route('admin.settings.footer') }}" class="sidebar-link {{ request()->routeIs('admin.settings.footer') ? 'active' : '' }}">
                                <i class="fas fa-shoe-prints"></i> Footer Settings
                            </a>
                            <a href="{{ route('admin.settings.contact') }}" class="sidebar-link {{ request()->routeIs('admin.settings.contact') ? 'active' : '' }}">
                                <i class="fas fa-address-book"></i> Contact Page Settings
                            </a>
                            <a href="{{ route('admin.settings.welcome') }}" class="sidebar-link {{ request()->routeIs('admin.settings.welcome') ? 'active' : '' }}">
            ...
            <div class="sidebar-footer">
                <span class="sidebar-role">
                    {{ Auth::user() && Auth::user()->roles ? Auth::user()->roles->pluck('name')->join(', ') : '' }}
                </span>
