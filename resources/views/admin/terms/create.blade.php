...
<div class="terms-container">
    <div class="terms-header">
        <h2><i class="fas fa-calendar-plus"></i> Create Term</h2>
        ...
        <div class="terms-card-body">
            <form action="{{ route('admin.terms.store') }}" method="POST">
                ...
                <div class="terms-form-group">
                    ...
                    <input type="text" id="name" name="name" class="terms-form-input @error('name') is-invalid @enderror" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="terms-form-row">
                    <div class="terms-form-group">
                        ...
                        <input type="date" id="start_date" name="start_date" class="terms-form-input @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}" required>
                        @error('start_date')
                            <div class="terms-error">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="terms-form-group">
                        ...
                        <input type="date" id="end_date" name="end_date" class="terms-form-input @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}" required>
                        @error('end_date')
                            <div class="terms-error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="terms-form-group">
                    ...
                    <textarea id="description" name="description" class="terms-form-input @error('description') is-invalid @enderror" rows="3">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="terms-error">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="terms-form-actions">
                    <button type="submit" class="terms-submit-btn">
                        <i class="fas fa-save"></i> Create Term
                    </button>
                </div>
            </form>
        </div>
