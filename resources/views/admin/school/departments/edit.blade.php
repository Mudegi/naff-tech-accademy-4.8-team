...
<div class="dashboard-content-inner department-form-page">
    ...
    <div class="dashboard-breadcrumbs">
        <div>
            ...
            <div class="breadcrumbs">
                ...
                <span><a href="{{ route('admin.school.departments.show', $department->id) }}">{{ $department->name }}</a></span> <span class="breadcrumb-sep">/</span> 
                <span class="breadcrumb-active">Edit</span>
            </div>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('admin.school.departments.show', $department->id) }}" class="btn-modern btn-secondary">
    ...
    <div class="form-card-modern">
        <div class="form-card-header">
            ...
            <div>
                <h2 class="form-card-title">Edit Department: {{ $department->name }}</h2>
                <p class="form-card-subtitle">Update the department information below</p>
            </div>
        </div>

        <form action="{{ route('admin.school.departments.update', $department->id) }}" method="POST" class="form-modern">
            @csrf
            @method('PUT')
                ...
                <div class="form-fields">
                    ...
                    <div class="form-group-modern">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Brief description of the department and its purpose...">{{ old('description', $department->description) }}</textarea>
                        @error('description')
                            <div class="form-error">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
            ...
            <div class="form-section">
                ...
                <div class="form-fields">
                    <div class="form-group-modern">
                        ...
                        <div class="select-wrapper">
                            <select id="head_of_department_id" 
                                ...
                                @foreach($availableHODs as $hod)
                                    <option value="{{ $hod->id }}" {{ old('head_of_department_id', $department->head_of_department_id) == $hod->id ? 'selected' : '' }}>
                                        {{ $hod->name }} ({{ $hod->email }})
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-help-text">
                            <i class="fas fa-info-circle mr-1"></i>
                            Select a Head of Department to lead this department. You can change this anytime.
                        </div>
