...
<div class="dashboard-content-inner school-dashboard">
    ...
    <div class="school-hero-card mb-8">
        <div class="school-hero-content">
            ...
            <div class="school-hero-right">
                ...
                <a href="{{ route('admin.school.settings') }}" class="school-settings-btn">
        ...
        <div class="stat-card-modern stat-card-primary">
            ...
            <div class="stat-card-body">
                ...
                <div class="stat-sublabel-modern">
                    <span class="stat-badge-info">{{ $stats['directors'] }} Directors</span>
                    <span class="stat-badge-secondary">{{ $stats['heads_of_department'] }} HODs</span>
                </div>
            </div>
        </div>
    ...
    <div class="stats-grid">
        <div class="stat-card-modern stat-card-secondary">
            ...
            <div class="stat-card-body">
                <div class="stat-value-modern">{{ $stats['directors'] }}</div>
        ...
        <div class="stat-card-modern stat-card-accent">
            ...
            <div class="stat-card-body">
                <div class="stat-value-modern">{{ $stats['heads_of_department'] }}</div>
        ...
        <div class="stat-card-modern stat-card-teal">
            ...
            <div class="stat-card-body">
                <div class="stat-value-modern">{{ $stats['teachers'] }}</div>
    ...
    <div class="dashboard-section-card">
        ...
        <div class="quick-actions-grid">
            <a href="{{ route('admin.school.staff.index') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.school.settings') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.grade-scales.index') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.subjects.index') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.school.departments.index') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.users.student-parent-list') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.school.subscriptions.index') }}" class="quick-action-card">
            ...
            <a href="{{ route('admin.school.resources.index') }}" class="quick-action-card">
                <div class="quick-action-icon quick-action-icon-indigo">
            ...
            <a href="{{ route('admin.school.students.index') }}" class="quick-action-card">
    ...
    <div class="dashboard-section-card">
        <div class="section-header">
            ...
            <a href="{{ route('admin.school.staff.index') }}" class="view-all-link">
                    ...
                    <tr>
                        <td>
                            <div class="table-cell-content">
                                ...
                                <span class="table-name">{{ $staff->name }}</span>
                            </div>
                        </td>
                        <td>{{ $staff->email }}</td>
                        <td>
                        ...
                        <td>
                            <span class="table-badge {{ $staff->is_active ? 'table-badge-success' : 'table-badge-danger' }}">
