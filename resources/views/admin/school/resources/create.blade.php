...
<div class="dashboard-content-inner">
    ...
    <div class="dashboard-breadcrumbs">
        <h1 class="dashboard-title">Create Resource</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mt-6">
        <form action="{{ route('admin.school.resources.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="learning_outcomes" 
                              ...
                              class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('learning_outcomes') }}</textarea>
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <label class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('visible_as_sample') == '1' ? 'checked' : '' }}
                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
