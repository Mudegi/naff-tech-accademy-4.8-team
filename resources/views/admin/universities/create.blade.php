...
<div class="dashboard-content-inner">
    <div class="dashboard-breadcrumbs" style="margin-bottom: 2rem;">
        ...
        <div class="breadcrumbs" style="margin-top: 0.5rem;">
            ...
            <span style="color: #9ca3af; margin: 0 0.5rem;">/</span>
            <span style="color: #6b7280;">Create</span>
        </div>
    </div>
    ...
    <form action="{{ route('admin.universities.store') }}" method="POST" class="form-card" style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 1200px;">
        @csrf
        ...
        <div class="form-section" style="margin-bottom: 30px;">
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required class="form-input" placeholder="e.g., Makerere University">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code') }}" class="form-input" placeholder="e.g., MAK" maxlength="50">
                    <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="base_url" id="base_url" value="{{ old('base_url') }}" class="form-input" placeholder="https://example.ac.ug">
                    <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
        ...
        <div class="form-section" style="margin-bottom: 30px;">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="url_pattern" id="url_pattern" value="{{ old('url_pattern') }}" class="form-input" placeholder="https://example.ac.ug/cut-off-points/{year}-{nextYear}.pdf">
                <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                <div class="form-group">
                    ...
                    <select name="scraper_type" id="scraper_type" required class="form-input">
                        <option value="auto" {{ old('scraper_type', 'auto') == 'auto' ? 'selected' : '' }}>Auto-detect</option>
                        <option value="pdf" {{ old('scraper_type') == 'pdf' ? 'selected' : '' }}>PDF</option>
                        <option value="html_table" {{ old('scraper_type') == 'html_table' ? 'selected' : '' }}>HTML Table</option>
                        <option value="html_custom" {{ old('scraper_type') == 'html_custom' ? 'selected' : '' }}>HTML Custom</option>
                    </select>
                    <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
                ...
                <div class="form-group">
                    ...
                    <select name="cut_off_format" id="cut_off_format" required class="form-input">
                        <option value="standard" {{ old('cut_off_format', 'standard') == 'standard' ? 'selected' : '' }}>Standard (Single cut-off)</option>
                        <option value="makerere" {{ old('cut_off_format') == 'makerere' ? 'selected' : '' }}>Makerere (STEM with gender-specific)</option>
                        <option value="kyambogo" {{ old('cut_off_format') == 'kyambogo' ? 'selected' : '' }}>Kyambogo</option>
                        <option value="custom" {{ old('cut_off_format') == 'custom' ? 'selected' : '' }}>Custom</option>
                    </select>
                    <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
        ...
        <div class="form-section" style="margin-bottom: 30px;">
            ...
            <div class="form-group">
                ...
                <textarea name="notes" id="notes" rows="4" class="form-input" placeholder="Any additional notes about this university...">{{ old('notes') }}</textarea>
                <small style="display: block; margin-top: 5px; color: #6b7280; font-size: 12px;">
            ...
            <div class="form-group" style="margin-top: 20px;">
                <label style="display: flex; align-items: center; cursor: pointer;">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} style="margin-right: 0.5rem; width: 18px; height: 18px;">
