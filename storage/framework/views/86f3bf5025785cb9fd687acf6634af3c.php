...
<div class="dashboard-content-inner">
    <div class="dashboard-breadcrumbs">
        ...
        <div class="breadcrumbs">
            <a href="<?php echo e(route('admin.university-cut-offs.index')); ?>">University Cut-Offs</a> <span class="breadcrumb-sep">/</span> <span class="breadcrumb-active">Edit</span>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('admin.university-cut-offs.update', $universityCutOff->id)); ?>" method="POST" class="form-card" style="background: white; border-radius: 12px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); max-width: 1200px;">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        
        <!-- Hidden fields required by validation -->
        <input type="hidden" name="degree_type" value="<?php echo e(old('degree_type', $universityCutOff->degree_type ?? 'bachelor')); ?>">
        <input type="hidden" name="program_category" value="<?php echo e(old('program_category', $universityCutOff->program_category ?? ($universityCutOff->cut_off_points_male || $universityCutOff->cut_off_points_female ? 'stem' : 'other'))); ?>">
        <input type="hidden" name="cut_off_format" value="<?php echo e(old('cut_off_format', $universityCutOff->cut_off_format ?? 'standard')); ?>">
        ...
        <div class="form-section" style="margin-bottom: 30px;">
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" name="university_name" id="university_name" value="<?php echo e(old('university_name', $universityCutOff->university_name)); ?>" required class="form-input" readonly style="background: #f3f4f6;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="course_name" id="course_name" value="<?php echo e(old('course_name', $universityCutOff->course_name)); ?>" required class="form-input">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="course_code" id="course_code" value="<?php echo e(old('course_code', $universityCutOff->course_code)); ?>" class="form-input">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="academic_year" id="academic_year" value="<?php echo e(old('academic_year', $universityCutOff->academic_year)); ?>" required min="2000" max="<?php echo e(date('Y') + 1); ?>" class="form-input">
                </div>
            </div>
        </div>
        ...
        <div class="form-section" style="margin-bottom: 30px;">
            ...
            <div class="form-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="number" name="minimum_principal_passes" id="minimum_principal_passes" value="<?php echo e(old('minimum_principal_passes', $universityCutOff->minimum_principal_passes)); ?>" required min="1" max="5" class="form-input">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="cut_off_points" id="cut_off_points" value="<?php echo e(old('cut_off_points', $universityCutOff->cut_off_points)); ?>" step="0.1" min="0" max="100" class="form-input" placeholder="20.5">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="cut_off_points_male" id="cut_off_points_male" value="<?php echo e(old('cut_off_points_male', $universityCutOff->cut_off_points_male)); ?>" step="0.1" min="0" max="100" class="form-input" placeholder="43.3">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="cut_off_points_female" id="cut_off_points_female" value="<?php echo e(old('cut_off_points_female', $universityCutOff->cut_off_points_female)); ?>" step="0.1" min="0" max="100" class="form-input" placeholder="36.4">
                </div>
            </div>
        </div>
        ...
        <div class="form-actions" style="display: flex; justify-content: flex-end; gap: 15px; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
            <a href="<?php echo e(route('admin.university-cut-offs.index')); ?>" class="dashboard-btn dashboard-btn-secondary">
