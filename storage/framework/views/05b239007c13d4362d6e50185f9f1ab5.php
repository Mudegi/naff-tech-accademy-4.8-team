...
<div class="performance-container">
    ...
    <div class="overall-card">
        ...
        <div class="overall-stats">
            <div class="stat-box primary">
                <div class="stat-value"><?php echo e($overallMetrics['overall_average']); ?>%</div>
                <div class="stat-label">Overall Average</div>
                <div class="stat-grade">Grade: <?php echo e($overallMetrics['letter_grade']); ?></div>
            </div>
            <div class="stat-box <?php echo e($overallMetrics['trend_direction'] === 'improving' ? 'success' : ($overallMetrics['trend_direction'] === 'declining' ? 'danger' : 'secondary')); ?>">
                <div class="stat-icon">
                    <?php if($overallMetrics['trend_direction'] === 'improving'): ?>
                        <i class="fas fa-arrow-up"></i>
                    <?php elseif($overallMetrics['trend_direction'] === 'declining'): ?>
                        <i class="fas fa-arrow-down"></i>
                    <?php else: ?>
                        <i class="fas fa-arrows-alt-h"></i>
                    <?php endif; ?>
                </div>
                <div class="stat-value"><?php echo e(abs($overallMetrics['trend'])); ?>%</div>
                <div class="stat-label">
                    <?php echo e(ucfirst($overallMetrics['trend_direction'])); ?>

                </div>
            </div>
            <div class="stat-box info">
                <div class="stat-value"><?php echo e($overallMetrics['total_activities']); ?></div>
    ...
    <div class="breakdown-grid">
        ...
        <div class="breakdown-card">
            ...
            <div class="card-body">
                <div class="metric">
                    ...
                    <span class="metric-value"><?php echo e($assignmentPerformance['average_grade']); ?>%</span>
                </div>
                <div class="metric">
                    <span class="metric-label">Total Completed:</span>
                    <span class="metric-value"><?php echo e($assignmentPerformance['total']); ?></span>
                </div>
                <div class="metric">
                    <span class="metric-label">On-Time Rate:</span>
                    <span class="metric-value"><?php echo e($assignmentPerformance['on_time_rate']); ?>%</span>
                </div>
                <div class="metric">
                    <span class="metric-label">Graded:</span>
                    <span class="metric-value success"><?php echo e($assignmentPerformance['graded']); ?></span>
                </div>
                <div class="metric">
                    <span class="metric-label">Pending:</span>
                    <span class="metric-value warning"><?php echo e($assignmentPerformance['pending']); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="breakdown-card">
            ...
            <div class="card-body">
                <div class="metric">
                    <span class="metric-label">Average Grade:</span>
                    <span class="metric-value"><?php echo e($examPerformance['average_grade']); ?>%</span>
                </div>
                <div class="metric">
                    <span class="metric-label">Total Exams:</span>
                    <span class="metric-value"><?php echo e($examPerformance['total']); ?></span>
                </div>
                <div class="metric">
                    <span class="metric-label">Principal Passes:</span>
                    <span class="metric-value"><?php echo e($examPerformance['principal_passes']); ?></span>
                </div>
                <div class="metric">
                    <span class="metric-label">Aggregate Points:</span>
                    <span class="metric-value"><?php echo e($examPerformance['aggregate_points']); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="breakdown-card">
            ...
            <div class="card-body">
                <div class="metric">
                    <span class="metric-label">Average Grade:</span>
                    <span class="metric-value"><?php echo e($groupWorkPerformance['average_grade']); ?>%</span>
                </div>
                <div class="metric">
                    <span class="metric-label">Total Projects:</span>
                    <span class="metric-value"><?php echo e($groupWorkPerformance['total']); ?></span>
                </div>
                <div class="metric">
                    <span class="metric-label">Active Groups:</span>
                    <span class="metric-value"><?php echo e($groupWorkPerformance['groups_active']); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="subject-section">
        ...
        <?php if(count($subjectBreakdown) > 0): ?>
            <div class="subject-grid">
                <?php $__currentLoopData = $subjectBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="subject-card">
                        <div class="subject-header">
                            <h4><?php echo e($subject['subject']); ?></h4>
                            <span class="subject-grade grade-<?php echo e(strtolower($subject['letter_grade'])); ?>">
                                <?php echo e($subject['letter_grade']); ?>

                            </span>
                        </div>
                        <div class="subject-average"><?php echo e($subject['average']); ?>%</div>
                        <div class="subject-stats">
                            <span><i class="fas fa-clipboard"></i> <?php echo e($subject['assignment_count']); ?> assignments</span>
                            <span><i class="fas fa-file-alt"></i> <?php echo e($subject['exam_count']); ?> exams</span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill" style="width: <?php echo e($subject['average']); ?>%"></div>
                        </div>
                    </div>
        ...
        <?php if(count($recentActivity) > 0): ?>
            <div class="activity-timeline">
                <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="activity-item <?php echo e($activity['status']); ?>">
                        ...
                        <div class="activity-content">
                            ...
                            <div class="activity-details">
                                <span class="activity-grade">Grade: <?php echo e($activity['grade']); ?> (<?php echo e($activity['percentage']); ?>%)</span>
                                <span class="activity-letter-grade"><?php echo e($activity['letter_grade']); ?></span>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode(array_column($performanceTrends, 'month'), 512) ?>,
                datasets: [{
                    label: 'Average Performance (%)',
                    data: <?php echo json_encode(array_column($performanceTrends, 'average'), 512) ?>,
