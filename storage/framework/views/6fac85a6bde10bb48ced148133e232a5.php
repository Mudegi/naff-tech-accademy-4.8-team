...
<div class="dashboard-content-inner cutoffs-page">
    ...
    <div class="cutoffs-actions-bar">
        <a href="<?php echo e(route('admin.university-cut-offs.export', request()->query())); ?>" class="dashboard-btn export-btn">
            <i class="fas fa-file-download"></i> <span class="btn-text">Export to Excel</span>
        </a>
        <a href="<?php echo e(route('admin.university-cut-offs.import')); ?>" class="dashboard-btn import-btn">
            <i class="fas fa-file-upload"></i> <span class="btn-text">Import from CSV/Excel</span>
        </a>
        <a href="<?php echo e(route('admin.university-cut-offs.create')); ?>" class="dashboard-btn dashboard-btn-primary create-btn">
