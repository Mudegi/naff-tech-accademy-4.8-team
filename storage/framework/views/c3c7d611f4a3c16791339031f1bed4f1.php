<?php $__env->startSection('title', 'Assessment Management'); ?>
...
<div class="dashboard-content">
    <div class="content-header">
        ...
        <div class="header-right">
            <a href="<?php echo e(route('teacher.assessments.create')); ?>" class="btn btn-primary">
                ...
                <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="resource-card">
                        ...
                        <div class="resource-content">
                            <p class="resource-description"><?php echo e(Str::limit($resource->description, 150)); ?></p>
                                ...
                                <div class="file-section">
                                    ...
                                    <?php if($resource->assessment_tests_path): ?>
                                        <div class="file-info">
                                            ...
                                            <div class="file-actions">
                                                <a href="<?php echo e(route('teacher.assessments.download.assessment', $resource->id)); ?>" 
                                                   class="btn btn-sm btn-outline-primary">
                                                    <i class="fas fa-download"></i> Download
                                                </a>
                                                <button class="btn btn-sm btn-outline-danger" 
                                                        onclick="deleteAssessment(<?php echo e($resource->id); ?>)">
                                    ...
                                    <?php else: ?>
                                        <div class="file-upload">
                                            <form id="assessmentForm<?php echo e($resource->id); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="upload-area">
                                                    <input type="file" 
                                                           id="assessmentFile<?php echo e($resource->id); ?>" 
                                                           name="assessment_tests" 
                                                           accept=".pdf" 
                                                           class="file-input"
                                                           onchange="uploadAssessment(<?php echo e($resource->id); ?>)">
                                                    <label for="assessmentFile<?php echo e($resource->id); ?>" class="upload-label">
                                ...
                                <div class="file-section">
                                    ...
                                    <?php if($resource->notes_file_path): ?>
                                        <div class="file-info">
                                            ...
                                            <div class="file-actions">
                                                <a href="<?php echo e(route('teacher.assessments.download.notes', $resource->id)); ?>" 
                                                   class="btn btn-sm btn-outline-primary">
                                                    <i class="fas fa-download"></i> Download
                                                </a>
                                                <button class="btn btn-sm btn-outline-danger" 
                                                        onclick="deleteNotes(<?php echo e($resource->id); ?>)">
                                                    <i class="fas fa-trash"></i> Delete
                                                </button>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="file-upload">
                                            <form id="notesForm<?php echo e($resource->id); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <div class="upload-area">
                                                    <input type="file" 
                                                           id="notesFile<?php echo e($resource->id); ?>" 
                                                           name="notes_file" 
                                                           accept=".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx" 
                                                           class="file-input"
                                                           onchange="uploadNotes(<?php echo e($resource->id); ?>)">
                                                    <label for="notesFile<?php echo e($resource->id); ?>" class="upload-label">
                                                        <i class="fas fa-upload"></i>
                        ...
                        <div class="resource-footer">
                            <a href="<?php echo e(route('teacher.assessments.show', $resource->id)); ?>" 
                               class="btn btn-primary">
                                <i class="fas fa-eye"></i> View Details
                            </a>
                            <span class="resource-date">
                                Created: <?php echo e($resource->created_at->format('M d, Y')); ?>
