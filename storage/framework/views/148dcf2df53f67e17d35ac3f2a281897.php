...
<div class="dashboard-content-inner">
    <div class="dashboard-breadcrumbs" style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div>
            <a href="<?php echo e(route('admin.resources.edit', $resource->hash_id)); ?>" class="dashboard-btn dashboard-btn-primary">Edit Resource</a>
            <a href="<?php echo e(route('admin.resources.index')); ?>" class="dashboard-btn dashboard-btn-secondary">Back to Resources</a>
        </div>
    </div>
        ...
        <div class="profile-row">
            <div class="profile-col profile-col-details">
                <div class="profile-form-group">
                    <label>Title</label>
                    <p class="profile-value"><?php echo e($resource->title); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Description</label>
                    <p class="profile-value"><?php echo e($resource->description); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Subject</label>
                    <p class="profile-value"><?php echo e($resource->subject ? $resource->subject->name : '-'); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Class</label>
                    <p class="profile-value"><?php echo e($resource->classRoom ? $resource->classRoom->name : '-'); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Topic</label>
                    <p class="profile-value"><?php echo e($resource->topic ? $resource->topic->name : '-'); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Term</label>
                    <p class="profile-value"><?php echo e($resource->term ? $resource->term->name : '-'); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Grade Level</label>
                    <p class="profile-value"><?php echo e($resource->grade_level); ?></p>
                </div>
            </div>
            ...
            <div class="profile-col profile-col-password">
                <div class="profile-form-group">
                    ...
                    <?php if($resource->video_url): ?>
                        <p class="profile-value">
                            <span class="video-url-display" style="display: none;"><?php echo e($resource->video_url); ?></span>
                        </p>
                        <?php
                            $videoId = null;
                        ...
                        <?php if($videoId): ?>
                            <div class="video-preview" style="margin-top: 10px; position: relative;">
                                <iframe 
                                    ...
                                    width="560" 
                                    height="315" 
                                    src="https://www.youtube.com/embed/<?php echo e($videoId); ?>?modestbranding=1&rel=0&showinfo=0&controls=1&disablekb=1&fs=0&iv_load_policy=3" 
                ...
                <div class="profile-form-group">
                    ...
                    <?php if($resource->google_drive_link): ?>
                        <p class="profile-value">
                            <span class="drive-url-display" style="display: none;"><?php echo e($resource->google_drive_link); ?></span>
                        </p>
                        <?php
                            $fileId = null;
                        ...
                        <?php if($fileId): ?>
                            <div class="drive-preview" style="margin-top: 10px; position: relative;">
                                <iframe 
                                    ...
                                    width="560" 
                                    height="315" 
                                    src="https://drive.google.com/file/d/<?php echo e($fileId); ?>/preview" 
                ...
                <div class="profile-form-group">
                    ...
                    <?php if($resource->notes_file_path): ?>
                        <p class="profile-value">
                            <a href="<?php echo e(Storage::url($resource->notes_file_path)); ?>" target="_blank" class="dashboard-link">
                                <?php echo e(basename($resource->notes_file_path)); ?>

                            </a>
                            <span class="file-type">(<?php echo e(strtoupper($resource->notes_file_type)); ?>)</span>
                        </p>
                        <?php
                        ...
                        <div class="notes-preview" style="margin-top: 15px;">
                            <?php if($fileExtension == 'pdf'): ?>
                                <iframe 
                                    src="<?php echo e($fileUrl); ?>#toolbar=1&navpanes=1&scrollbar=1&zoom=100" 
                                    width="100%" 
                                    height="400" 
                ...
                <div class="profile-form-group">
                    ...
                    <?php if($resource->assessment_tests_path): ?>
                        <p class="profile-value">
                            <a href="<?php echo e(Storage::url($resource->assessment_tests_path)); ?>" target="_blank" class="dashboard-link">
                                <?php echo e(basename($resource->assessment_tests_path)); ?>

                            </a>
                            <span class="file-type">(<?php echo e(strtoupper($resource->assessment_tests_type)); ?>)</span>
                        </p>
                        <div class="assessment-preview" style="margin-top: 15px;">
                            <iframe 
                                src="<?php echo e(Storage::url($resource->assessment_tests_path)); ?>#toolbar=0&navpanes=0&scrollbar=1" 
                                width="100%" 
                                height="400" 
                                style="border: 1px solid #ddd; border-radius: 4px;"
                ...
                <div class="profile-form-group">
                    ...
                    <div class="profile-value">
                        <?php if($resource->tags_array): ?>
                            <?php $__currentLoopData = $resource->tags_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="profile-form-group">
                    <label>Status</label>
                    <p class="profile-value">
                        <span class="status-badge <?php echo e($resource->is_active ? 'status-active' : 'status-inactive'); ?>">
                            <?php echo e($resource->is_active ? 'Active' : 'Inactive'); ?>
                ...
                <div class="profile-form-group">
                    ...
                    <p class="profile-value"><?php echo e($resource->creator ? $resource->creator->name : '-'); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Created At</label>
                    <p class="profile-value"><?php echo e($resource->created_at->format('M d, Y H:i A')); ?></p>
                </div>

                <div class="profile-form-group">
                    <label>Last Updated</label>
                    <p class="profile-value"><?php echo e($resource->updated_at->format('M d, Y H:i A')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php if($resource->learning_outcomes): ?>
            ...
            <div class="learning-outcomes-content">
                ...
                <?php if(count($learningOutcomes) > 0): ?>
                    <div class="outcomes-list">
                        <?php $__currentLoopData = $learningOutcomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $outcome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="outcome-item">
                                <div class="outcome-number"><?php echo e($index + 1); ?></div>
                                <div class="outcome-text"><?php echo e($outcome); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
