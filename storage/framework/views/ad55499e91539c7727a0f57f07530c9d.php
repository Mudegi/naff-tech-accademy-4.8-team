...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.settings.flutterwave.update')); ?>">
                <?php echo csrf_field(); ?>
                
                <div class="form-group">
                    <label for="public_key">Public Key</label>
                    <input type="text" id="public_key" name="public_key" 
                        value="<?php echo e(old('public_key', $settings->public_key ?? '')); ?>" 
                        class="form-input <?php $__errorArgs = ['public_key'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="secret_key" name="secret_key" 
                        value="<?php echo e(old('secret_key', $settings->secret_key ?? '')); ?>" 
                        class="form-input <?php $__errorArgs = ['secret_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="encryption_key" name="encryption_key" 
                        value="<?php echo e(old('encryption_key', $settings->encryption_key ?? '')); ?>" 
                        class="form-input <?php $__errorArgs = ['encryption_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                    <?php $__errorArgs = ['encryption_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="webhook_secret" name="webhook_secret" 
                        ...
                        class="form-input <?php $__errorArgs = ['webhook_secret'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="currency_code" name="currency_code" 
                        value="<?php echo e(old('currency_code', $settings->currency_code ?? 'UGX')); ?>" 
                        class="form-input <?php $__errorArgs = ['currency_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" name="test_mode" value="1" 
                            <?php echo e(old('test_mode', $settings->test_mode ?? true) ? 'checked' : ''); ?>>
                        Test Mode
                    </label>
                </div>
