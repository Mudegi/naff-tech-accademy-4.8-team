...
<div class="container">
    <div class="settings-container">
        ...
        <form action="<?php echo e(route('admin.settings.welcome.update')); ?>" method="POST" class="settings-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="settings-section">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="hero_title" id="hero_title" value="<?php echo e(old('hero_title', $welcomePage->hero_title ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="hero_subtitle" id="hero_subtitle" value="<?php echo e(old('hero_subtitle', $welcomePage->hero_subtitle ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid-2">
                    <?php for($i = 1; $i <= 10; $i++): ?>
                        <div class="form-group">
                            <label for="hero_image_<?php echo e($i); ?>" class="form-label">
                                <i class="fas fa-image"></i> Hero Image <?php echo e($i); ?>

                                <small class="image-requirements">(Min: 1200x600px, Max: 5MB)</small>
                            </label>
                            <input type="file" name="hero_image_<?php echo e($i); ?>" id="hero_image_<?php echo e($i); ?>" 
                                class="form-input file-input" accept="image/*">
                            <?php if($welcomePage && $welcomePage->{'hero_image_' . $i}): ?>
                                <div class="current-image">
                                    <p class="current-image-label">Current Image:</p>
                                    <img src="<?php echo e(Storage::url($welcomePage->{'hero_image_' . $i})); ?>" 
                                         alt="Current Hero Image <?php echo e($i); ?>" class="preview-image">
                                </div>
                            <?php endif; ?>
                            <?php $__errorArgs = ['hero_image_' . $i];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="about_title" id="about_title" value="<?php echo e(old('about_title', $welcomePage->about_title ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="about_description" id="about_description" rows="4" class="form-input form-textarea"><?php echo e(old('about_description', $welcomePage->about_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->about_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->about_image)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="features_title" id="features_title" value="<?php echo e(old('features_title', $welcomePage->features_title ?? '')); ?>" class="form-input">
                    <?php $__errorArgs = ['features_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="features_description" id="features_description" rows="4" class="form-input form-textarea"><?php echo e(old('features_description', $welcomePage->features_description ?? '')); ?></textarea>
                    <?php $__errorArgs = ['features_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->features_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->features_image)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="testimonials_title" id="testimonials_title" value="<?php echo e(old('testimonials_title', $welcomePage->testimonials_title ?? '')); ?>" class="form-input">
                    <?php $__errorArgs = ['testimonials_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="testimonials_description" id="testimonials_description" rows="4" class="form-input form-textarea"><?php echo e(old('testimonials_description', $welcomePage->testimonials_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->testimonials_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->testimonials_image)); ?>" 
                                 alt="Current Testimonials Image" class="preview-image">
                        </div>
                    <?php endif; ?>
                    <?php $__errorArgs = ['testimonials_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="cta_title" id="cta_title" value="<?php echo e(old('cta_title', $welcomePage->cta_title ?? '')); ?>" class="form-input">
                    <?php $__errorArgs = ['cta_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="cta_description" id="cta_description" rows="4" class="form-input form-textarea"><?php echo e(old('cta_description', $welcomePage->cta_description ?? '')); ?></textarea>
                    <?php $__errorArgs = ['cta_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->cta_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->cta_image)); ?>" 
            ...
            <div class="settings-section">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <?php if($welcomePage && $welcomePage->login_image): ?>
                            <div class="current-image">
                                <p class="current-image-label">Current Image:</p>
                                <img src="<?php echo e(Storage::url($welcomePage->login_image)); ?>" 
                                     alt="Current Login Image" class="preview-image">
                            </div>
                        <?php endif; ?>
                        <?php $__errorArgs = ['login_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($welcomePage && $welcomePage->register_image): ?>
                            <div class="current-image">
                                <p class="current-image-label">Current Image:</p>
                                <img src="<?php echo e(Storage::url($welcomePage->register_image)); ?>" 
                                     alt="Current Register Image" class="preview-image">
                            </div>
                        <?php endif; ?>
                        <?php $__errorArgs = ['register_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="<?php echo e(old('meta_title', $welcomePage->meta_title ?? '')); ?>" class="form-input">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="meta_description" id="meta_description" rows="4" class="form-input form-textarea"><?php echo e(old('meta_description', $welcomePage->meta_description ?? '')); ?></textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="meta_keywords" id="meta_keywords" value="<?php echo e(old('meta_keywords', $welcomePage->meta_keywords ?? '')); ?>" class="form-input">
                    </div>
            ...
            <div class="settings-section">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="og_title" id="og_title" value="<?php echo e(old('og_title', $welcomePage->og_title ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($welcomePage && $welcomePage->og_image): ?>
                            <div class="current-image">
                                <p class="current-image-label">Current Image:</p>
                                <img src="<?php echo e(Storage::url($welcomePage->og_image)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="og_description" id="og_description" rows="4" class="form-input form-textarea"><?php echo e(old('og_description', $welcomePage->og_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="twitter_title" id="twitter_title" value="<?php echo e(old('twitter_title', $welcomePage->twitter_title ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if($welcomePage && $welcomePage->twitter_image): ?>
                            <div class="current-image">
                                <p class="current-image-label">Current Image:</p>
                                <img src="<?php echo e(Storage::url($welcomePage->twitter_image)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="twitter_description" id="twitter_description" rows="4" class="form-input form-textarea"><?php echo e(old('twitter_description', $welcomePage->twitter_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mission_title" id="mission_title" value="<?php echo e(old('mission_title', $welcomePage->mission_title ?? '')); ?>" class="form-input">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="mission_description" id="mission_description" rows="4" class="form-input form-textarea"><?php echo e(old('mission_description', $welcomePage->mission_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->mission_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->mission_image)); ?>" 
                                 alt="Current Mission Image" class="preview-image">
                        </div>
                    <?php endif; ?>
                    <?php $__errorArgs = ['mission_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="team_title" id="team_title" value="<?php echo e(old('team_title', $welcomePage->team_title ?? '')); ?>" class="form-input">
                    <?php $__errorArgs = ['team_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="team_description" id="team_description" rows="4" class="form-input form-textarea"><?php echo e(old('team_description', $welcomePage->team_description ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->team_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->team_image)); ?>" 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="values_title" id="values_title" value="<?php echo e(old('values_title', $welcomePage->values_title ?? '')); ?>" class="form-input">
                    <?php $__errorArgs = ['values_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="values_description" id="values_description" rows="4" class="form-input form-textarea"><?php echo e(old('values_description', $welcomePage->values_description ?? '')); ?></textarea>
                    <?php $__errorArgs = ['values_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($welcomePage && $welcomePage->values_image): ?>
                        <div class="current-image">
                            <p class="current-image-label">Current Image:</p>
                            <img src="<?php echo e(Storage::url($welcomePage->values_image)); ?>" 
                                 alt="Current Values Image" class="preview-image">
                        </div>
                    <?php endif; ?>
                    <?php $__errorArgs = ['values_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
