...
<div class="dashboard-content-inner">
    <div class="dashboard-breadcrumbs" style="margin-bottom: 1.5rem;">
        <a href="<?php echo e(route('admin.dashboard')); ?>" style="color: #667eea; text-decoration: none;">Dashboard</a>
        <span style="color: #9ca3af; margin: 0 0.5rem;">/</span>
        <a href="<?php echo e(route('admin.university-cut-offs.index')); ?>" style="color: #667eea; text-decoration: none;">University Cut-Offs</a>
        <span style="color: #9ca3af; margin: 0 0.5rem;">/</span>
    ...
    <div class="dashboard-card" style="margin-bottom: 2rem;">
        <form action="<?php echo e(route('admin.university-cut-offs.import.store')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
            <?php echo csrf_field(); ?>
