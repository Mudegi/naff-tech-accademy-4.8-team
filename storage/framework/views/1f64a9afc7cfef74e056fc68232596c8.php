...
<div class="assignments-page">
    ...
    <div class="filters-section">
        <form method="GET" action="<?php echo e(route('teacher.assignments.index')); ?>" class="filters-form">
            <div class="filters-grid">
                ...
                <div class="filter-group">
                    ...
                    <select name="grade_range" id="grade_range" class="filter-select">
                        <option value="">All Grades</option>
                        <option value="excellent" <?php echo e(request('grade_range') === 'excellent' ? 'selected' : ''); ?>>Excellent (90-100%)</option>
                        <option value="good" <?php echo e(request('grade_range') === 'good' ? 'selected' : ''); ?>>Good (80-89%)</option>
                        <option value="average" <?php echo e(request('grade_range') === 'average' ? 'selected' : ''); ?>>Average (70-79%)</option>
                        <option value="below_average" <?php echo e(request('grade_range') === 'below_average' ? 'selected' : ''); ?>>Below Average (60-69%)</option>
                        <option value="poor" <?php echo e(request('grade_range') === 'poor' ? 'selected' : ''); ?>>Poor (<60%)</option>
                    </select>
                </div>
                ...
                <div class="filter-group">
                    ...
                    <input type="text" name="student_name" id="student_name" class="filter-input" 
                           placeholder="Search by student name..." value="<?php echo e(request('student_name')); ?>">
                </div>
            ...
            <div class="filter-actions">
                ...
                <a href="<?php echo e(route('teacher.assignments.index')); ?>" class="btn btn-secondary">
                    <i class="fas fa-times"></i> Clear Filters
                </a>
                <a href="<?php echo e(route('teacher.assignments.reports.student-scores')); ?>?<?php echo e(http_build_query(request()->query())); ?>" class="btn btn-success">
                    <i class="fas fa-file-download"></i> Download Scores Report
                </a>
                <a href="<?php echo e(route('teacher.assignments.bulk.form')); ?>" class="btn btn-info">
                ...
                <div class="assignment-card">
                    <div class="assignment-header">
                        <div class="student-info">
                            <h3><?php echo e($assignment->student->name); ?></h3>
                            <p class="resource-title"><?php echo e($assignment->resource->title); ?></p>
                        </div>
                        <div class="assignment-meta">
                            <span class="submission-date">
                                <i class="fas fa-calendar"></i>
                                <?php echo e($assignment->submitted_at->format('M d, Y H:i A')); ?>
                    ...
                    <div class="assignment-actions">
                        <a href="<?php echo e(route('teacher.assignments.show', $assignment->id)); ?>" class="btn btn-primary">
                            <i class="fas fa-eye"></i> View Assignment
                        </a>
                        <a href="<?php echo e(route('teacher.assignments.download', $assignment->id)); ?>" class="btn btn-secondary">
                            <i class="fas fa-download"></i> Download
                        </a>
                        <?php if($assignment->status === 'submitted'): ?>
                            <button class="btn btn-success" onclick="markAsReviewed(<?php echo e($assignment->id); ?>)">
                    ...
                    <?php if($assignment->teacher_feedback): ?>
                        <div class="feedback-section">
                            <h4>Your Feedback:</h4>
                            <p><?php echo e($assignment->teacher_feedback); ?></p>
                        </div>
                    <?php endif; ?>
                    
                    <?php if($assignment->grade): ?>
                        <div class="grade-section">
                            <h4>Grade: <span class="grade-value"><?php echo e($assignment->grade); ?>%</span></h4>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
