...
<div class="video-page">
    ...
    <div class="video-header">
        ...
        <h1 class="video-title"><?php echo e($resource->title); ?></h1>
    </div>
    ...
    <div class="video-section">
        <?php if($driveFileId): ?>
            <div class="video-wrapper" id="videoWrapper">
                ...
                <iframe 
                    src="https://drive.google.com/file/d/<?php echo e($driveFileId); ?>/preview" 
    ...
    <?php if(auth()->check() && auth()->user()->account_type === 'student' && $resource->assessment_tests_path): ?>
            ...
            <div class="assessment-content">
                <div class="file-info">
                    ...
                    <div class="file-details">
                        <h3 class="file-name"><?php echo e(basename($resource->assessment_tests_path)); ?></h3>
                        <p class="file-type">PDF Document - Assessment Test</p>
                    </div>
                    <div class="file-actions">
                        <a href="<?php echo e(asset('storage/' . $resource->assessment_tests_path)); ?>" target="_blank" class="download-btn">
                    ...
                    <?php if($existingAssignment): ?>
                        ...
                        <div class="submitted-assignment">
                            ...
                            <div class="assignment-details">
                                <p><strong>Submitted:</strong> <?php echo e($existingAssignment->submitted_at->format('M d, Y H:i A')); ?></p>
                                <p><strong>Status:</strong> 
                                    <span class="status-badge status-<?php echo e($existingAssignment->status); ?>">
                                        <?php echo e(ucfirst($existingAssignment->status)); ?>
                                ...
                                <div class="assignment-actions">
                                    <a href="<?php echo e(route('student.my-assignments.download', $existingAssignment->id)); ?>" class="download-assignment-btn">
                                        <i class="fas fa-download"></i> Download My Assignment
                                    </a>
                                    <a href="<?php echo e(route('student.my-assignments.report', $existingAssignment->id)); ?>" class="download-report-btn">
                                        <i class="fas fa-file-pdf"></i> Download Report
                                    </a>
                                </div>
                                
                                <?php if($existingAssignment->teacher_feedback): ?>
                                    <div class="teacher-feedback">
                                        <h5>Teacher Feedback:</h5>
                                        <p><?php echo e($existingAssignment->teacher_feedback); ?></p>
                                    </div>
                                <?php endif; ?>
                                <?php if($existingAssignment->grade): ?>
                                    <div class="grade-display">
                                        <h5>Grade: <span class="grade-value"><?php echo e($existingAssignment->grade); ?>%</span></h5>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <?php if(auth()->check() && auth()->user()->account_type === 'teacher' && auth()->id() == $resource->teacher_id): ?>
        <div class="assessment-tests-section">
            <div class="section-header">
                <i class="fas fa-clipboard-check"></i>
        ...
        <?php if($resource->notes_file_path): ?>
            <div class="notes-content">
                ...
                <div class="file-info">
                    ...
                    <div class="file-details">
                        <h3 class="file-name"><?php echo e($fileName); ?></h3>
                        <p class="file-type"><?php echo e(strtoupper($fileExtension)); ?> Document - Study Material</p>
                    </div>
                    <div class="file-actions">
                        <a href="<?php echo e($fileUrl); ?>" target="_blank" class="download-btn">
                            <i class="fas fa-download"></i> Download
                        </a>
                    </div>
                </div>
    ...
    <div class="comments-section">
        ...
        <?php $isLoggedIn = auth()->check(); $currentUserId = auth()->id(); ?>
        <?php if($isLoggedIn): ?>
        ...
        <?php else: ?>
        <div class="login-to-comment">Please <a href="<?php echo e(route('login')); ?>">log in</a> to comment.</div>
        <?php endif; ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const resourceId = <?php echo json_encode($resource->id, 15, 512) ?>;
        const commentsList = document.getElementById('commentsList');
        const isLoggedIn = <?php echo json_encode($isLoggedIn, 15, 512) ?>;
        const currentUserId = <?php echo json_encode($currentUserId, 15, 512) ?>;
        ...
        if (videoFrame) {
            try {
                ...
                if (video) {
                    ...
                    fetch('<?php echo e(route("student.videos.track")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        ...
                        body: JSON.stringify({
                            resource_id: '<?php echo e($resource->id); ?>',
    ...
    if (fileInput && uploadBtn) {
        ...
        if (assessmentForm) {
            assessmentForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', `/student/videos/<?php echo e($resource->id); ?>/upload-assessment`);
                xhr.send(formData);
            });
        }
    }
    ...
    if (notesFileInput && notesUploadBtn) {
        ...
        if (notesForm) {
            notesForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', `/student/videos/<?php echo e($resource->id); ?>/upload-notes`);
                xhr.send(formData);
            });
        }
    }
    ...
    if (assignmentFileInput && assignmentUploadBtn) {
        ...
        if (assignmentForm) {
            assignmentForm.addEventListener('submit', function(e) {
                ...
                xhr.open('POST', `/student/videos/<?php echo e($resource->id); ?>/upload-assignment`);
                xhr.send(formData);
            });
        }
    }
