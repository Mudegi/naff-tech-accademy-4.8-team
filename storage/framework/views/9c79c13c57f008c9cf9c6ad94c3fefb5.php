                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="team-position"><?php echo e($team->position); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="sort-order"><?php echo e($team->sort_order); ?></span>
                            </td>
                            <td>
                                <span class="status-badge <?php echo e($team->is_active ? 'active' : 'inactive'); ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <form action="<?php echo e(route('admin.teams.toggle-status', $team)); ?>" 
                                          method="POST" class="inline-form">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <button type="submit" 
                                                class="btn btn-sm <?php echo e($team->is_active ? 'btn-secondary' : 'btn-success'); ?>"
                                                title="<?php echo e($team->is_active ? 'Deactivate' : 'Activate'); ?>">
                                            <i class="fas fa-<?php echo e($team->is_active ? 'pause' : 'play'); ?>"></i>
                                        </button>
                                    </form>
                                    <form action="<?php echo e(route('admin.teams.destroy', $team)); ?>" 
                                          method="POST" class="inline-form"
