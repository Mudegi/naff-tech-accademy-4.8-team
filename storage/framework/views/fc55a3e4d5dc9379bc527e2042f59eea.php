...
<div class="dashboard-content-inner">
    ...
    <?php if($user->account_type === 'admin' && !$user->school_id): ?>
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
            ...
            <div>
                <div style="font-weight: 600; font-size: 1rem; margin-bottom: 0.25rem;">
                    <?php if($currentSchoolContext): ?>
                        Working in: <strong><?php echo e($currentSchoolContext->name); ?></strong>
                    <?php else: ?>
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem; position: relative;">
            <div style="position: relative;">
                <button id="schoolContextBtn" style="padding: 0.5rem 1rem; border-radius: 0.375rem; border: 1px solid rgba(255,255,255,0.3); background: rgba(255,255,255,0.25); color: white; font-size: 0.875rem; cursor: pointer; min-width: 200px; text-align: left; display: flex; align-items: center; justify-content: space-between; font-weight: 500;">
                    <span id="schoolContextBtnText"><?php if($currentSchoolContext): ?><?php echo e($currentSchoolContext->name); ?><?php else: ?> Select School...<?php endif; ?></span>
                ...
                <div id="schoolContextDropdown" style="display: none; position: absolute; top: 100%; left: 0; margin-top: 0.5rem; background: white; border-radius: 0.5rem; box-shadow: 0 10px 25px rgba(0,0,0,0.15); min-width: 300px; z-index: 1000; max-height: 400px; overflow: hidden; flex-direction: column;">
                    ...
                    <div id="schoolContextList" style="max-height: 300px; overflow-y: auto;">
                        <a href="<?php echo e(route('admin.school-context.switch')); ?>" class="school-context-option" data-school-id="" style="display: block; padding: 0.75rem 1rem; color: #374151; text-decoration: none; transition: background 0.2s; border-bottom: 1px solid #f3f4f6;" onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='white'">
                        ...
                        <a href="<?php echo e(route('admin.school-context.switch', $school->id)); ?>" class="school-context-option" data-school-id="<?php echo e($school->id); ?>" data-school-name="<?php echo e($school->name); ?>" style="display: block; padding: 0.75rem 1rem; color: #374151; text-decoration: none; transition: background 0.2s; border-bottom: 1px solid #f3f4f6;" onmouseover="this.style.background='#f3f4f6'" onmouseout="this.style.background='white'">
                            <div style="font-weight: 500;">🏫 <?php echo e($school->name); ?></div>
                            <?php if($currentSchoolContext && $currentSchoolContext->id == $school->id): ?>
    ...
    <div class="stat-cards">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($contactMessages->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalSubjects); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalTopics); ?></div>
    ...
    <div class="stat-cards mt-4">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalResources); ?></div>
    ...
    <div class="stat-cards mt-4">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalStudentAssignments); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-icon stat-icon-green">📝</div>
            <div class="stat-info">
                <div class="stat-value"><?php echo e($totalTeacherAssignments); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-icon stat-icon-yellow">⏳</div>
            <div class="stat-info">
                <div class="stat-value"><?php echo e($submittedAssignments); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-icon stat-icon-purple">✅</div>
            <div class="stat-info">
                <div class="stat-value"><?php echo e($gradedAssignments); ?></div>
    ...
    <div class="dashboard-table-container mb-4">
        ...
        <div class="quick-actions">
            <a href="<?php echo e(route('admin.assignments.index')); ?>" class="dashboard-btn dashboard-btn-primary">
                <i class="fas fa-clipboard-list"></i> View Student Submissions
            </a>
            <a href="<?php echo e(route('admin.teacher-assignments.index')); ?>" class="dashboard-btn dashboard-btn-secondary">
    ...
    <div class="dashboard-table-container mb-4">
        ...
        <div class="quick-actions">
            <a href="<?php echo e(route('admin.users.student-parent-list')); ?>" class="dashboard-btn dashboard-btn-primary">
                <i class="fas fa-users"></i> Student-Parent Accounts
            </a>
            <a href="<?php echo e(route('admin.parent-student.bulk-import')); ?>" class="dashboard-btn dashboard-btn-secondary">
    ...
    <div class="dashboard-table-container">
        ...
        <div class="dashboard-table-scroll">
            <table class="dashboard-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $contactMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($message->id); ?></td>
                        <td class="font-bold"><?php echo e($message->name); ?></td>
